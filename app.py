...
def create_medical_report(report_type, image_path=None, result=None, confidence=None, 
    ...
    pdf.cell(0, 5, "BoneScan AI Software", 0, 1, 'C')
    pdf.set_font('Arial', '', 10)
    pdf.cell(0, 5, "NATIONAL INSTITUTE OF TECHNOLOGY MEGHALAYA,SOHRA,INDIA", 0, 1, 'C')
    pdf.cell(0, 5, "Phone: +91 9903487969 | License: MED2025", 0, 1, 'C')
    pdf.ln(5)
