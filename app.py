...
def create_pdf(patient_name, doctor_name, result, confidence_percent, selected_model_name, timestamp):
    pdf = FPDF()
    ...
    pdf.image("path/to/logo.png", 10, 8, 30)  # Ensure the correct path to your logo
...
with st.sidebar:
    st.image("path/to/logo.png", width=100)  # Replace with your logo path
...
if uploaded_file:
    ...
    with st.spinner("Processing image..."):
        ...
        if st.button("Download Report"):
            report_filename = create_pdf(patient_name, doctor_name, result, confidence_percent, selected_model_name, timestamp)
